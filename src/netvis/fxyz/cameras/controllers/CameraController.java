...
import netvis.fxyz.extras.AbstractTransformable;
import netvis.fxyz.extras.Transformable;
...
/**
 * An abstract class for a camera controller.
 * Improvement contains changing extended class from {@link Transformable} to {@link AbstractTransformable}. For more
 * information see {@link AbstractTransformable}.
 * @author Dub, improvement by Michal Piskozub
 */
public abstract class CameraController extends AbstractTransformable {
    ...
    protected abstract void handlePrimaryMouseRelease(MouseEvent e);

    protected abstract void handleSecondaryMouseRelease(MouseEvent e);

    protected abstract void handleMiddleMouseRelease(MouseEvent e);
    ...
    private void handleMouseEvent(MouseEvent t) {
        if (t.getEventType() == MouseEvent.MOUSE_PRESSED) {
            ...
            switch (t.getButton()) {
                case PRIMARY:
                    handlePrimaryMouseRelease(t);
                    break;
                case MIDDLE:
                    handleMiddleMouseRelease(t);
                    break;
                case SECONDARY:
                    handleSecondaryMouseRelease(t);
                    break;
                default:
                    throw new AssertionError();
            }
