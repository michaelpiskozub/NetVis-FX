 ...
 */
package netvis.fxyz.cameras;

import javafx.scene.AmbientLight;
import javafx.scene.Group;
import javafx.scene.PerspectiveCamera;
import javafx.scene.PointLight;
import netvis.fxyz.cameras.controllers.CameraController;

/**
 * Creates a version of a camera with an advanced functionality.
 * @author Dub
 */
...
//        pointLight.getScope().add(AdvancedCamera.this);
//        ambientLight.getScope().add(AdvancedCamera.this);
        wrapper.getChildren().addAll(AdvancedCamera.this, pointLight, ambientLight);
